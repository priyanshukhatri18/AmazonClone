...
const COLUDINARY_API_URL = `https://api.cloudinary.com/v1_1/${CLOUDINARY_CLOUD_NAME}/image/upload`;
...
export const uploadFileToCloudinary = async (
    ...
    try {
        ...
        if (file && file.uri){
            ...
            const response = await axios.post(COLUDINARY_API_URL, formData, {
                headers: {
                    "Content-Type": "multipart/form-data",
                },
            });

            console.log("upload mage result response: ", response?.data);
